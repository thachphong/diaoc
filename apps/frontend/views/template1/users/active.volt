	...
	<div class="container register_form">		
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="pn_posts">
				...
				<div class="pn_content margin_top pn_background pn_border login_form">
					...
					<div class="row row-margin-bottom" style="text-align: center;">
							<label class="col-md-12 col-sm-12 col-xs-12 title_col">Nếu bạn chưa có tài khoản của datxanhviet.vn, vui lòng <a class="link_color" href="{{url.get('dang-ky')}}"><strong>đăng ký tại đây</strong></a></label>
